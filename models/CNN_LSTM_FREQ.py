...
class CNN_LSTM_FREQ_Model(nn.Module):

    def __init__(self, input_shape, number_class , number_filters=64):
        super(CNN_LSTM_FREQ_Model, self).__init__()
